...
export default function EmailVerification() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen ">
      <form onSubmit={handleVerification} className="w-full max-w-md gap-3 flex flex-col shadow-md border  rounded-lg px-10 py-7">
        ...
        <input
          ...
          required
           className="rounded-lg text-black bg-transparent border   py-2 px-3"
        />
        <button 
          type="submit" 
          disabled={processing}
